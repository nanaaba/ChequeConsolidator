...
<html lang="en">
   <head>
        ...
        <title>Log In -Cheque Consolator </title>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/login-3.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('css/logincustom.css')); ?>">
